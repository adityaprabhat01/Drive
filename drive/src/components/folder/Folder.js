  ...
  render() {
    ...
    return (
      <div className="d-flex flex-column border border-dark">
        <svg onClick={this.FolderView} width="5em" height="5em" viewBox="0 0 16 16" className="bi bi-folder" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <span className="text-center">{this.state.f.name}</span>
      </div>
